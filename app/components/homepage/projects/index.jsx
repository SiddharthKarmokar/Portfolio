        ...
        <div className="flex flex-col gap-6">
          {projectsData.map((project, index) => (
            <div
              ...
              // Dynamically adds 20px (or any value) of extra space per card
              style={{ top: `${80 + index * 20}px` }} 
            >
              <div className="box-border flex items-center justify-center rounded shadow-[0_0_30px_0_rgba(0,0,0,0.3)] bg-white transition-all duration-[0.5s]">
